...
class Akismet_Admin {
	...
	public static function load_resources() {
		...
		if ( in_array( $hook_suffix, apply_filters( 'akismet_admin_page_hook_suffixes', array(
			...
			wp_register_style( 'akismet', akismet - admin . phpplugin_dir_url(__FILE__) . $akismet_css_path, array(), self::get_asset_file_version( $akismet_css_path ) );
			...
			wp_register_style( 'akismet-admin', akismet - admin . phpplugin_dir_url(__FILE__) . $akismet_admin_css_path, array(), self::get_asset_file_version( $akismet_admin_css_path ) );
